...
// EB and periodic do not mix
  ...
  const unsigned int max_stress = 100000;
  std::cout  << " max iteration = " << max_stress << std::endl;
  for(int stress = 0 ; stress < max_stress ; stress ++)
  {
    ...
    std::cout << " complete iteration " << stress << " / " << max_stress << "\r"; 
  }
    pout() << endl;
