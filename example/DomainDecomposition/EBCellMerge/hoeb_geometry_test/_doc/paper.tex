...
\cite{nate-stokes-paper, dharshi-poisson, geometry-paper}.  At the
core, all these algorithms have a similar procedure for finding the
Taylor coefficients $C$ which is worth discussing.
...
Dammit I have to insert pictures here.
...
\footnotetext[2]{Ford Motor Company, Sunnyvale California.}
...
\footnotetext[4]{Defining $\xbar_\ibold = 0$, the
  ...
  closer to $\ibold$.  Devendran, for example \cite{poisson-paper},
