...
That these algorithms invert a matrix to compute
...
\section{All Regular geometry}

To investigate the consequences of this geometry, we consider as a
motivating example a geometry wherein all cells are uncut.  
