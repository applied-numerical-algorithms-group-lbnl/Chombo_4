...
the absence of boundary condition equtions   They show that, for
...
resulting in poorly-conditioned matrices.    Their data shows the
worst solvability issues near the domain boundary.    It stands to
