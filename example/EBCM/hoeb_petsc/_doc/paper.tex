...
\end{equation}
If we know the local Taylor coefficients,
...
\footnotetext[3]{This includes corner volumes.   The neighborhood is
  ...
  is formed by growing the box made from the low and high cells of
  the target face, growing it by $N_G$ and intersecting with the
...
\footnotetext[5]{The 
  ...
  receive  higher weights.  Diagonal weighting matrices are common.
